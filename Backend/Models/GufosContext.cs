...
namespace Backend.Models
{
    public partial class GufosContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server= N-1S-DEV-17\\SQLEXPRESS; Database=Gufos; User Id=sa;Password=132");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Categoria>(entity =>
            {
                entity.HasIndex(e => e.Titulo)
                    .HasName("UQ__Categori__7B406B566B8CD7C5")
                    .IsUnique();
            ...
            modelBuilder.Entity<Localizacao>(entity =>
            {
                entity.HasIndex(e => e.Cnpj)
                    .HasName("UQ__Localiza__AA57D6B4E166F180")
                    .IsUnique();

                entity.HasIndex(e => e.RazaoSocial)
                    .HasName("UQ__Localiza__7DD02876C5C0E7A5")
                    .IsUnique();
            ...
            {
                entity.HasIndex(e => e.Titulo)
                    .HasName("UQ__Tipo_Usu__7B406B561F4D4C80")
                    .IsUnique();
            ...
            modelBuilder.Entity<Usuario>(entity =>
            {
                entity.HasIndex(e => e.Email)
                    .HasName("UQ__Usuario__A9D10534C1240B77")
                    .IsUnique();
